					...
					<div id="slider-carousel" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							<div class="item active">
								<div class="col-sm-6">
									<h1>CÔNG TY TNHH CƠ KHÍ</h1>
									<h2>NGUYỄN MINH</h2>
									<!-- <button type="button" class="btn btn-default get">Get it now</button> -->
								</div>
								<div class="col-sm-6">
									<img style="min-height: 400px; object-fit: cover;max-height: 400px;min-width: 390px;" src="public/images/img_banner/1.jpg" class="girl img-responsive" alt="" />
								</div>
							</div>
							...
							<div class="item">
								...
								<div class="col-sm-6">
									<img style="min-height: 400px; object-fit: cover;max-height: 400px;min-width: 390px;" src="public/images/img_banner/2.jpg" class="girl img-responsive" alt="" />
								</div>
							</div>
							<?php }?>
						</div>
